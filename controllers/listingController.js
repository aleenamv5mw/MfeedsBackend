...
// Function to update the RSS feed with new content
async function updateRSSFeed() {
  try {
    const query = "Finnish Rennovation"; // Modify the query here as needed
    const results = await searchListings(query);
...
module.exports = {
  //getting list of  all listings under finnish rennovation
